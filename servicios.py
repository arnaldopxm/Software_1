...
def calcularPrecio(tarifa: Tarifa, tiempoServicio: [datetime.datetime]) -> float:
    ...
    if (inicio.month != fin.month):
        ...
        if (fin.day == inicio.day):
            ...
            return calcularMonto(tiempo,cobro)
            ...
            if(fin.day - inicio.day == 1):
                ...
                return calcularMonto(horasf,cobrof)+calcularMonto(horasi,cobroi)
                ...
                while i-1 > 0 and i<=7:
                    ...
                    if (temp<5):
                        ...
                        cobrot = tarifa.tarifaFinSemana
                    suma += calcularMonto(24,cobrot)
                    i-=1

                if (i>7):
                    return "ERROR"

                return suma+calcularMonto(horasf,cobrof)+calcularMonto(horasi,cobroi)
